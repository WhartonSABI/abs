...
`publication_eligible` is true only for the 6,261 challenges in the official
Savant analytical set. Two live-feed-only rulings remain in sequential
inventory reconstruction and are explicitly quarantined from published rates.

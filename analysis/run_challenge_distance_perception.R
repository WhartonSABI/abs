...
#
# Fast held-out pilot:
#   Rscript analysis/run_challenge_distance_perception.R fast
#
# Longer held-out confirmation fit after reviewing the pilot:
#   Rscript analysis/run_challenge_distance_perception.R full
#
# Quick full-season MDP preview:
#   Rscript analysis/run_challenge_distance_perception.R quick_mdp
#
# Five-fold perception and MDP analysis with fixed sharp p_hat:
#   Rscript analysis/run_challenge_distance_perception.R crossfit_mdp

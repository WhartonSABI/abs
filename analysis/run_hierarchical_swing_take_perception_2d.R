...
#   source("analysis/run_hierarchical_swing_take_perception_2d.R")
#
...
invisible(lapply(file.path(
  project_root, "scripts", "functions",
  c(
    "utils.R", "geometry.R", "swing_take_perception.R",
    "swing_take_perception_2d.R"
  )
), source))

...
#   Rscript analysis/run_joint_bayesian_perception.R pilot
#   Rscript analysis/run_joint_bayesian_perception.R finalists
#   Rscript analysis/run_joint_bayesian_perception.R full
#   Rscript analysis/run_joint_bayesian_perception.R crossfit
#   Rscript analysis/run_joint_bayesian_perception.R mdp
